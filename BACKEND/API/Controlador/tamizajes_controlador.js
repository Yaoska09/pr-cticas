...
const consultas = require('../Modelo/TAMIZAJE/tamizajes_consultas');
...
const add = (req, res) => {
    const {id_menor,periodo,resultado } = req.body;
    pool.query(consultas.getByCorreo, [correo], (error, results) => {//modificar siguiendo el archivo de consulta en  la carpeta MODELO
        ...
        pool.query(consultas.add, [id_menor,periodo,resultado], (error, results) => {
            if (error) throw error;
